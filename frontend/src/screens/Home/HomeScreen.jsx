    ...
    <div className='w-[100%] h-auto overflow-auto bg-productBackground'>
      ...
      <div className='w-[100%] h-auto float-left flex flex-wrap items-start justify-center overflow-auto'>
        ...
        <div className='w-[80%] h-auto py-2 my-2 text-xs font-semibold text-black flex items-center justify-end'>
          <span className='px-2 py-1.5 rounded-2xl border border-subNav hover:border-borderColor hover:bg-borderColor hover:text-black' onClick={()=>navigate('allproducts')}>Veiw All</span>
        </div>
        <div className='w-auto h-auto pb-20 grid grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-10 sm:gap-6'>
          {numMap.map((data)=>{
            return(
